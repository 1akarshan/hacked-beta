...
def main():
    ...
    while True:
        ...
        if results.multi_hand_landmarks is not None:
            for hand_landmarks, handedness in zip(results.multi_hand_landmarks,
                ...
                hand_sign_id, acc = keypoint_classifier(
                ...
                # print(acc*100, '%')
                # HAND SIGN COUNT
                SIGNS_SEEN.append(hand_sign_id)
    ...
    print(dict_max[max(SIGNS_SEEN, key=SIGNS_SEEN.count)])
...
class KeyPointClassifier(object):
    ...
    def __call__(
        ...
        accuracy = result[0][result_index]

        return result_index, accuracy
